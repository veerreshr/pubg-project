...
<body>
    ...
    <div class="details">
        <center><h1><b>SQUAD TOURNMENT</b></h1></center><br><br>
        ...
        echo" <button onclick=\"location.href='squadpay.php';\" style=\" width:200px; padding:10px; background-color:teal;color:white; font-weight:bold; margin:20px;\"";
        if($_SESSION['squadcount']>=25)
         {echo " disabled";}   
         echo ">FOR PAYMENT</button>";
         if($_SESSION['duocount']>=25)
