...
<body>
    ...
    <div class="details">
        <center><h1><b>SOLO TOURNMENT</b></h1></center><br><br>
       ...
       echo" <button onclick=\"location.href='solopay.php';\" style=\" width:200px; padding:10px; background-color:teal;color:white; font-weight:bold; margin:20px;\" "; 
